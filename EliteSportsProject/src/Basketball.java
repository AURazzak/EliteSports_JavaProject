...
//                dispose();
                ...
                try {
                    d.browse(new URI("https://m.aiscore.com/basketball"));
...
//                dispose();
                Desktop d = Desktop.getDesktop();
                try {
                    d.browse(new URI("https://www.courtside1891.basketball/"));
                } catch (IOException | URISyntaxException ex) {
                    throw new RuntimeException(ex);
                }
...
//                dispose();
                Desktop d = Desktop.getDesktop();
                try {
                    d.browse(new URI("https://www.youtube.com/results?search_query=basketball+highlights"));
                } catch (IOException | URISyntaxException ex) {
                    throw new RuntimeException(ex);
                }
...
//                dispose();
                Desktop d = Desktop.getDesktop();
                try {
                    d.browse(new URI("https://www.espn.in/nba/schedule"));
                } catch (IOException | URISyntaxException ex) {
                    throw new RuntimeException(ex);
                }
