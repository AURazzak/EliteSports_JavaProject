...
//                dispose(); // Close the current RegisterFrom frame
                ...
                String DuplicateEmailCheckQuery = "SELECT * FROM `elitesportsjava`";
                ...
                String DuplicateMoibleCheckQuery = "SELECT * FROM `elitesportsjava`";
                ...
                {
                    String insertQuery = "INSERT INTO `elitesportsjava`(`Username`, `Mobile`, `Email`, `Address`, `Password`) VALUES ('"+Name+"','"+Mobile+"','"+Email+"','"+Address+"','"+pass+"')";
